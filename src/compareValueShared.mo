...
module {
  public func equal(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
  ...
  public func greaterOrLess(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
      case (#Text(value)) target.11 == Path.EXISTING_VALUE and value != target.0;
      case (#Principal(value)) target.11 == Path.EXISTING_VALUE and Principal.toText(value) != target.0;
      case (#Blob(value)) target.11 == Path.EXISTING_VALUE and value != target.1;
  ...
  public func greater(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
      case (#Text(value)) target.11 == Path.EXISTING_VALUE and value > target.0;
      case (#Principal(value)) target.11 == Path.EXISTING_VALUE and Principal.toText(value) > target.0;
      case (#Blob(value)) target.11 == Path.EXISTING_VALUE and value > target.1;
  ...
  public func greaterOrEqual(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
      case (#Text(value)) target.11 == Path.EXISTING_VALUE and value >= target.0;
      case (#Principal(value)) target.11 == Path.EXISTING_VALUE and Principal.toText(value) >= target.0;
      case (#Blob(value)) target.11 == Path.EXISTING_VALUE and value >= target.1;
  ...
  public func less(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
      case (#Text(value)) target.11 == Path.EXISTING_VALUE and value < target.0;
      case (#Principal(value)) target.11 == Path.EXISTING_VALUE and Principal.toText(value) < target.0;
      case (#Blob(value)) target.11 == Path.EXISTING_VALUE and value < target.1;
  ...
  public func lessOrEqual(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
      case (#Text(value)) target.11 == Path.EXISTING_VALUE and value <= target.0;
      case (#Principal(value)) target.11 == Path.EXISTING_VALUE and Principal.toText(value) <= target.0;
      case (#Blob(value)) target.11 == Path.EXISTING_VALUE and value <= target.1;
  ...
  public func like(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
  ...
  public func ilike(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
  ...
  public func unlike(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
  ...
  public func iunlike(value: Candy.CandyShared, target: Path.Value): Bool {
    return switch (value) {
  ...
  public func compare(value: Candy.CandyShared, operator: Path.Operator, target: Path.Value): Bool {
    switch (operator) {
